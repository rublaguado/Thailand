...
The program expects a directory containing one CSV file for each of the 77 provinces of Thailand:

For each CSV:
- There must be a numeric column named exactly Incidence_norm. This column contains the monthly dengue incidence per 100,000 inhabitants, from 1983 to 2023.
